...
%AppPluginSmokeTest Smoke tests for plugin class loading and argument routing
    ...
    properties (TestParameter)
        PluginClassName = { ...
            ...
            'nansen.module.twophoton.ui.signalviewer.DffExplorer', ...
            'nansen.module.twophoton.ui.signalviewer.CaimanDeconvolution', ...
            'nansen.module.twophoton.ui.imviewer.NoRMCorre', ...
            'nansen.module.twophoton.ui.imviewer.FlowRegistration', ...
            'nansen.module.twophoton.ui.imviewer.EXTRACT', ...
            'nansen.module.twophoton.ui.imviewer.FluFinder', ...
    ...
    methods (Test, TestTags="Graphical")
        ...
        function testModalPluginConstructorRoutesOptionsAndPropertyPairs(testCase)
            ...
            plugin = nansen.module.twophoton.ui.imviewer.NoRMCorre(...
