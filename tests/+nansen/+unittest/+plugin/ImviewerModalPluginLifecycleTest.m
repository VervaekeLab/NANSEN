...
%ImviewerModalPluginLifecycleTest Lifecycle smoke tests for imviewer plugins
    ...
    methods (Static)
        ...
        function pluginSpecs = getPluginSpecs()
            pluginSpecs = { ...
                struct( ...
                    'ClassName', 'nansen.module.twophoton.ui.imviewer.NoRMCorre', ...
                    'Constructor', @nansen.module.twophoton.ui.imviewer.NoRMCorre, ...
                    'Options', nansen.unittest.plugin.ImviewerModalPluginLifecycleTest.getMotionOptions(), ...
                    'OptionPath', {{'Preview', 'numFrames'}}, ...
                    'NewValue', 11), ...
                struct( ...
                    'ClassName', 'nansen.module.twophoton.ui.imviewer.FlowRegistration', ...
                    'Constructor', @nansen.module.twophoton.ui.imviewer.FlowRegistration, ...
                    'Options', nansen.unittest.plugin.ImviewerModalPluginLifecycleTest.getMotionOptions(), ...
                    'OptionPath', {{'Preview', 'numFrames'}}, ...
                    'NewValue', 11), ...
                struct( ...
                    'ClassName', 'nansen.module.twophoton.ui.imviewer.EXTRACT', ...
                    'Constructor', @nansen.module.twophoton.ui.imviewer.EXTRACT, ...
                    'Options', nansen.unittest.plugin.ImviewerModalPluginLifecycleTest.getExtractOptions(), ...
                    'OptionPath', {{'Main', 'num_partitions_x'}}, ...
                    'NewValue', 3), ...
                struct( ...
                    'ClassName', 'nansen.module.twophoton.ui.imviewer.FluFinder', ...
                    'Constructor', @nansen.module.twophoton.ui.imviewer.FluFinder, ...
