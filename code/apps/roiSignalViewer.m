classdef roiSignalViewer < signalviewer.App
...
%
%   Alternative 1:
%       roiSignalViewer() opens a signal viewer instance without any data
%
%   Alternative 2:
%       roiSignalViewer(filePath) opens a signal viewer instance based on
%       file given as input
%
%  Alternative 3:
%       roiSignalViewer(roiSignalArray) opens a signal viewer instance
...
%
%       [ ] Y limits should be fixedbased on magnitude of full signals.
...
%       [x] Append and overwrite modes
    ...
    methods % Constructor
        ...
        function obj = roiSignalViewer(varargin)
...
% %         end
        ...
        function onRoiGroupSet(obj)
            ...
            el = addlistener(obj.RoiGroup, 'roiSelectionChanged', ...
