function [figH, EditHandle] = inputdlg2(Prompt, Title, NumLines, DefAns, Resize)
...
% Edited by EH such that figHandle and uicontrol editHandles are returned.
...
if nargout == 2
    figH = InputFig;
    EditHandle = arrayfun(@(i) uicontrol(i), EditHandle);
    return
end
