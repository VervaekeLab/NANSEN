classdef MetaTableColumnLayout < nansen.UserSettings
...
%   MetaTableViewer UI.
    ...
    properties(Constant, Hidden = true)
        ...
        DEFAULT_SETTINGS = nansen.MetaTableColumnLayout.getDefaultSettings()
...
%         
    ...
    methods (Static)
        ...
        function S = getSettings()
            S = getSettings@nansen.UserSettings('nansen.MetaTableColumnLayout');
        end
