...
% %         tmpItem = uimenu(m, 'Label', 'Open Roimanager');
% %         tmpItem.Callback = @(s, e, h, hAx, m) flufinder(obj, obj.uiaxes.imdisplay, tmpItem);
...
%             end
    ...
    %ADDAPPTOOLBAR Add toolbar for app related buttons/tools
        ...
        hAppbar.addButton('Icon', obj.ICONS.bulb, ...
            ...
            'ButtonDownFcn', @obj.toggleHelp, 'Tooltip', 'Show Clues', ...
            'Type', 'togglebutton');
