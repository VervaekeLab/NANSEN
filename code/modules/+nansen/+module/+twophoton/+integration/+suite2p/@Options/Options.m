classdef Options < nansen.wrapper.abstract.OptionsAdapter
    ...
    methods (Static)
        ...
        function S = getOptions()
            S = nansen.module.twophoton.integration.suite2p.Options.getDefaults();
        end

        function S = convert(S)

            if nargin < 1
                S = nansen.module.twophoton.integration.suite2p.Options.getOptions();
            end

            nameMap = nansen.module.twophoton.integration.suite2p.Options.getAdapter;
