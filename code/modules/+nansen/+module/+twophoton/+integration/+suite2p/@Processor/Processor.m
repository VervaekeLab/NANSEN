...
%nansen.module.twophoton.integration.suite2p.Processor Wrapper for running.suite2p within nansen
%
%   h = nansen.module.twophoton.integration.suite2p.Processor(imageStackReference) runs suite2p
...
%
%   h = nansen.module.twophoton.integration.suite2p.Processor(__, options) additionally
%       specifies the options to use for the processor.
%
%   To get the default options:
%       defOptions = nansen.module.twophoton.integration.suite2p.Processor.getDefaultOptions()
%
...
%           resulting from running suite2p autosegmentation
    ...
    properties (Constant) % Attributes inherited from nansen.processing.DataMethod
        ...
        OptionsManager nansen.manage.OptionsManager = ...
            nansen.OptionsManager('nansen.module.twophoton.integration.suite2p.Processor')
    end
    ...
    methods % Constructor
        ...
        %nansen.module.twophoton.integration.suite2p.Processor Construct suite2p processor
        %
        %   h = nansen.module.twophoton.integration.suite2p.Processor(imageStack) specifies the
    ...
    methods (Access = protected) % Implementation of RoiSegmentation methods
        ...
        %   struct of parameters for the suite2p pipeline.
            ...
            import nansen.module.twophoton.integration.suite2p.Options
        ...
        %mergeSpatialComponents Merge spatial components.
            ...
            import nansen.module.twophoton.integration.suite2p.utility.* % conversion functions
            ...
            S = nansen.module.twophoton.autosegmentation.flufinder.detect.mergeWeightedComponents(imageSize, S, ...
        ...
        %getRoiArray Get results as a roi array
            ...
            for i = 1:numZ
                for j = 1:numC
                    ...
                    roiArrayCell{i,j}  = nansen.module.twophoton.integration.suite2p.getRoiArray(S.stat, imageSize);
                end
            end
        end
