...
%
%   roiArray = nansen.module.twophoton.integration.suite2p.convertRois(S) converts rois in
...
% Todo: Make class (and roiconverter superclass)
    ...
    roiArray = nansen.module.twophoton.integration.suite2p.getRoiArray(S.stat, imageSize);
    ...
    imArray = nansen.module.twophoton.integration.extract.util.convertSpatialWeightsToThumbnails(roiArray, mask);
