classdef Options < nansen.wrapper.abstract.OptionsAdapter
    ...
    methods (Static)
        ...
        function S = convert(S)
            ...
            if nargin < 1
                S = nansen.module.twophoton.autosegmentation.suite2p.Options.getOptions();
            end

            nameMap = nansen.module.twophoton.autosegmentation.suite2p.Options.getOptionsConversionMap;
