...
%nansen.module.twophoton.autosegmentation.flufinder.Processor Wrapper for running Quicky within nansen
%
%   h = nansen.module.twophoton.autosegmentation.flufinder.Processor(imageStackReference) runs quicky
...
%
%   h = nansen.module.twophoton.autosegmentation.flufinder.Processor(__, options) additionally
%       specifies the options to use for the processor.
%
%   To get the default options:
%       defOptions = nansen.module.twophoton.autosegmentation.flufinder.Processor.getDefaultOptions()
%
...
% superclass check if results already exists.
    ...
    properties (Constant) % Attributes inherited from nansen.processing.DataMethod
        ...
        OptionsManager nansen.manage.OptionsManager = ...
            nansen.OptionsManager('nansen.module.twophoton.autosegmentation.flufinder.Processor')
    end
    ...
    methods % Constructor
        ...
        %nansen.module.twophoton.autosegmentation.flufinder.Processor Construct quicky processor
        %
        %   h = nansen.module.twophoton.autosegmentation.flufinder.Processor(imageStackReference)
        %
    ...
    methods (Access = protected) % Implementation of ImageStackProcessor methods
        ...
        function Y = preprocessImageData(obj, Y)
            ...
            % Todo:
            % Y_ = nansen.module.twophoton.autosegmentation.flufinder.preprocessImages(Y, options);
            %
        ...
        %segmentPartition Run segmentation on subpart of image stack
            ...
            Y_ = nansen.module.twophoton.autosegmentation.flufinder.module.preprocessImages(Y, options);
            BW = nansen.module.twophoton.autosegmentation.flufinder.module.binarizeImages(Y_, options);

            [S, CC] = nansen.module.twophoton.autosegmentation.flufinder.detect.getBwComponentStats(BW, options);
    ...
    methods (Access = protected) % Implementation of RoiSegmentation methods
        ...
        %   struct of parameters for the quicky algorithm.
            ...
            import nansen.module.twophoton.autosegmentation.flufinder.Options
        ...
        function mergeSpatialComponents(obj, iPlane, iChannel)
            ...
            import nansen.module.twophoton.autosegmentation.flufinder.detect.findUniqueRoisFromComponents
...
% %         end
        ...
        %finalizeResults Finalize the results using flufinder's pipeline
            ...
            for i = 1:obj.StackIterator.NumIterations
                ...
                [~, roiArrayT] = nansen.module.twophoton.autosegmentation.flufinder.utility.removeIsNanDff(fMean, roiArrayT);
                ...
                if opts.UseShapeDetection
                    ...
                    roiArrayS = nansen.module.twophoton.autosegmentation.flufinder.detect.shapeDetection(averageImage, roiArrayT, opts);
                    roiArray = nansen.module.twophoton.autosegmentation.flufinder.utility.combineRoiArrays(roiArrayS, roiArrayT, opts);
                else
                    roiArray = roiArrayT;
                end
