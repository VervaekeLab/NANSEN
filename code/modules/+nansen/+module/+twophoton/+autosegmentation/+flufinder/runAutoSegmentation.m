function [roiArray, summary] = runAutoSegmentation(imArray, varargin)
    ...
    [params, validators] = nansen.module.twophoton.autosegmentation.flufinder.getDefaultOptions('ungrouped');
    ...
    imArray = nansen.module.twophoton.autosegmentation.flufinder.module.preprocessImages(imArray, params);
    ...
    BW = nansen.module.twophoton.autosegmentation.flufinder.module.binarizeImages(imArray, params);

    % % Detect binary components based on brightness values of pixels
    % - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    fprintf('Detecting binary components...\n')

    S = nansen.module.twophoton.autosegmentation.flufinder.detect.getBwComponentStats(BW, params);
    roiArrayT = nansen.module.twophoton.autosegmentation.flufinder.detect.findUniqueRoisFromComponents(imageSize, S);
...
% % %     [fMean, roiArrayT] = nansen.module.twophoton.autosegmentation.flufinder.utility.removeIsNanDff(fMean, roiArrayT);
% % %
% % %     % get images:
...
% % %
% % %
% % %     roiArrayT = nansen.module.twophoton.autosegmentation.flufinder.module.improveRoiMasks(roiArrayT, roiImages);
    ...
    if params.UseShapeDetection
        ...
        roiArrayS = nansen.module.twophoton.autosegmentation.flufinder.detect.shapeDetection(averageImage, roiArrayT, params);
        roiArray = nansen.module.twophoton.autosegmentation.flufinder.utility.combineRoiArrays(roiArrayT, roiArrayS, params);
    else
        roiArray = roiArrayT;
    end
