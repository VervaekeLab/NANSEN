...
%   component detection step for use on an ImageStack object.
    ...
    for iPart = 1:dt:numParts
        ...
        bwArray = nansen.module.twophoton.autosegmentation.flufinder.module.binarizeImages(imArray);

        % Search for candidates based on activity in the binary stack
        S = nansen.module.twophoton.autosegmentation.flufinder.detect.getBwComponentStats(bwArray, params);
