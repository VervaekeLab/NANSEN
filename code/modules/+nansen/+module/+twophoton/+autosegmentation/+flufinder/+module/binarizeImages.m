...
%       params  : Struct of parameters for thresholding
    ...
    switch lower( params.RoiType )
        case 'soma'
            BW = nansen.module.twophoton.autosegmentation.flufinder.binarize.binarizeSomaStack(imArray, bwOpts);
        case 'axonal bouton'
            BW = nansen.module.twophoton.autosegmentation.flufinder.binarize.binarizeAxonStack(imArray, bwOpts);
        otherwise
