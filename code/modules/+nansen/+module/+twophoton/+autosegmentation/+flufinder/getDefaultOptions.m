...
%
%   P = nansen.module.twophoton.autosegmentation.flufinder.getDefaultOptions() returns a struct (P) with default
%       parameters for running flufinder's autosegmentation algorithm.
%
%   [P, V] = nansen.module.twophoton.autosegmentation.flufinder.getDefaultOptions() returns an additional struct (V)
...
%       nansen.module.twophoton.autosegmentation.flufinder.getDefaultOptions() ()
