...
%       FovRegistrationOptions
    ...
    methods (Access = public)
        ...
        %   array inherit the roi uid from the reference sessions.
            ...
            import nansen.module.twophoton.autosegmentation.flufinder.longitudinal.MultiSessionRoiCollection
            ...
            if ~nargout
                warning('multiSessionRoI is an array of handle objects. Type help nansen.module.twophoton.autosegmentation.flufinder.longitudinal.MultiSessionRoiCollection/addEntry for instruction on how to properly add entries to an object array of this class.')
                clear obj
            end
        end
    ...
    methods (Access = private) % Internal methods (updating rois)
        ...
        %   aligning a FoV image with the reference FoV image.
            ...
            newRois = nansen.module.twophoton.autosegmentation.flufinder.longitudinal.warpRois(refRois, fovShifts);
        ...
        %getFovPixelOffsets Get pixel offsets for FoV relative to reference FoV
            ...
            fovPixelOffsets = nansen.module.twophoton.autosegmentation.flufinder.longitudinal.alignFovs(fovImageArray);
        end
    end
    ...
    methods (Static)
        ...
        %   Convert rois to struct arrays on load.
            ...
            import nansen.module.twophoton.autosegmentation.flufinder.longitudinal.MultiSessionRoiCollection.isRoiArray
    ...
    methods (Static, Access = private) % Condider moving to roimanager.utilities
        ...
        function roiArray = resetRoiImageProperty(roiArray)
            import nansen.module.twophoton.autosegmentation.flufinder.longitudinal.MultiSessionRoiCollection.resetRoiImageProperty
            if isa(roiArray, 'cell')
