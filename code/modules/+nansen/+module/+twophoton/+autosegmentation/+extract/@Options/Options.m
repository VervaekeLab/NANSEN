classdef Options < nansen.wrapper.abstract.OptionsAdapter
    ...
    methods (Static)
        ...
        function S = getOptions()
            S = nansen.module.twophoton.autosegmentation.extract.Options.getDefaultOptions();
        end
        ...
        function SOut = convert(S)
            ...
            if nargin < 1
                S = nansen.module.twophoton.autosegmentation.extract.Options.getOptions();
            end
            ...
            for i = 1:numel(fieldsTopLevel)
                ...
                if strcmp(fieldsTopLevel{i}, 'CellFind')
                    nameMap = nansen.module.twophoton.autosegmentation.extract.Options.getOptionsConversionMap;
