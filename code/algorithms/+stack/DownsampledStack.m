classdef DownsampledStack < imviewer.ImageStack
...
%   See also imviewer.ImageStack.downsampleT    
...
%   planes..
    ...
    methods % Structors
        ...
        %DownsampledStack Constructor for creating a downsampled ImageStack
            ...
            if isa(imageData, 'imviewer.ImageStack') || isa(imageData, 'nansen.stack.ImageStack')
                imageData = stack.DownsampledStack.allocateData(imageData, ...
                    n, method, varargin{:});
            end
            
            obj@imviewer.ImageStack(imageData);
            
            obj.parseNameValuePairs(varargin{:})
    ...
    methods
        ...
        function addFrames(obj, data, indices)
            ...
            obj.brightnessLimits = [obj.MinPixelValue, obj.MaxPixelValue];
            
            
            % Finished?
            if obj.FrameCounter == obj.numFrames
                obj.IsFinished = true;
