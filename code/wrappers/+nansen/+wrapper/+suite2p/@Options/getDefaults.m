...
P.CellDetection.numBinnedFramesForSvd   = 5000;                 % how many (binned) timepoints to do the SVD based on
P.CellDetection.thresholdScalingFactor  = 1;                    % scale factor when applying threshold to detect peak indices from a log variance matrix.
