classdef (Abstract) Specification < matlab.mixin.SetGet % Todo: Inherit from StructAdapter
    ...
    % Constructor
    methods
        function obj = Specification(options)
            % Specification Construct a new Specification object
            %
            %   obj = Specification() creates a object with default values.
            %
            %   obj = Specification(options) initializes properties from
