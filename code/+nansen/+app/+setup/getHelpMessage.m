...
% % Data location page
    ...
    case 'Data location name'
        msg = {...
            'This is a name to describe the data location.\n', ...
    ...
    case 'Data type'
        msg = {...
            ...
            'This will determine access levels and whether or not a ', ...
            'data location can be set to default.\n', ...
            '\nRECORDED: Read access only. Can not be default', ...
            '\nPROCESSED: Read/write access. Can be default', ...
            '\nCURATED: Read/write access. Can not be default', ...
            };
...
% % Folder organization page
    ...
    case 'Folder Hierarchy Template'
         msg = {'Select a folder hierarchy template (optional)', ...
              '\nSelecting one of these templates will automatically fill ', ...
...
% % Metadata page
    ...
    case 'Selection mode'
        msg = {'Select mode for identifying substring:\n', ...
            ...
            '\n"expr": Enter a regular expression (see ''doc', ...
...
% % Variable page
    ...
    case 'Filename expression'
        msg = {'A part of the filename that uniquely identifies files', ...
            ...
            '\nExample: m0122-20200806-2109-001_XYT.raw', ...
