...
%   See also: nansen.plugin.base.PluginSpec, nansen.plugin.fileadapter.Registry
    ...
    methods
        ...
        %toLegacyStruct Convert to the struct shape returned by nansen.dataio.listFileAdapters.
            S = struct( ...
                ...
                'FileAdapterName',    char(obj.fileAdapterName()), ...
                'FunctionName',       char(obj.functionName()), ...
    ...
    methods (Access = private)
        ...
        function name = fileAdapterName(obj)
        %fileAdapterName Human-readable adapter name (DisplayName or Id fallback).
        ...
        function name = functionName(obj)
        %functionName MATLAB function name for constructing an adapter instance.
            kind = "";
